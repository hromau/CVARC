...
namespace AIRLab.Mathematics
{
    ...
    public struct Frame3D
    {
        ...
        {
            return String.Format("X = {0}, Y = {1}, Z = {2}, Pitch = {3}, Yaw = {4}, Roll = {5}",
                X.ToString(CultureInfo.InvariantCulture),
                Y.ToString(CultureInfo.InvariantCulture),
                Z.ToString(CultureInfo.InvariantCulture),
                Pitch.Grad.ToString(CultureInfo.InvariantCulture),
                Yaw.Grad.ToString(CultureInfo.InvariantCulture),
                Roll.Grad.ToString(CultureInfo.InvariantCulture));
        }


        public static Frame3D Parse(string line)
        {
            var ar= line.Replace("X = ", "")
                .Replace("Y = ", "")
                .Replace(" Z = ", "")
                .Replace(" Pitch = ", "")
                .Replace(" Yaw = ", "")
            ...
            //var match = new Regex(@"\s?[A-Za-z]* = (\d+[.,]?\d*)").Match(line);
            //return new Frame3D(
            //    double.Parse(match.Groups[0].Value, CultureInfo.InvariantCulture), 
            ...
            return new Frame3D(
                double.Parse(ar[0], CultureInfo.InvariantCulture),
